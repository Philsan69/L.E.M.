...
movement
 ...
 if g=0 && h>60 then scorecolor=68 else scorecolor=10
...
landedgood
 ...
 if wait=60 then AUDC0=12:AUDF0=14:AUDV0=6:scorecolor=196
 if wait=90 then AUDF0=21:scorecolor=10
 if wait=120 then AUDF0=14:scorecolor=196
